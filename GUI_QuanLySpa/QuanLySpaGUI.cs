using BLL_QuanLySpa;
using Do_An; // Namespace chứa các DTO của cậu
using System;
using System.Collections.Generic;
using System.Linq;
using System.Text;

namespace GUI_QuanLySpa // Namespace của GUI
{
    // Cậu dùng 'internal class' ở đây là OK
    internal class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            do
            {
                ...
                Console.WriteLine("| 1. Đọc/Tải lại dữ liệu từ file XML." + new string(' ', 22) + "|"); // Sửa tên
